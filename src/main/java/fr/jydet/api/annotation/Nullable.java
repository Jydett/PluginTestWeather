...
/**
 * On a method : indicate that the return type might be null
 * <p>On a parameter : indicate that the method can handle null parameter
 *
 ...
 *
 * @see fr.jydet.api.annotation.NotNull
 * @author Jydet
 */
